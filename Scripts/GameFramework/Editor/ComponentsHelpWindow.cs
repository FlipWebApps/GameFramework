...
namespace GameFramework.Localisation.Editor
{
    ...
    public class ComponentsHelpWindow : EditorWindow
    {
        ...
        ComponentHelp[] _componentHelps =
        {
            ...
            new ComponentHelp("EnableBasedUponCharacter", "Enable or a Disable a gameobject or UI button based upon various conditions relating to a specific Character or otherwise.", typeof(GameStructure.Characters.Components.EnableBasedUponCharacter), "GameStructure", "Character"),
            ...
            new ComponentHelp("EnableBasedUponLevel", "Enable or a Disable a gameobject or UI button based upon various conditions relating to a specific Level or otherwise.", typeof(GameStructure.Levels.Components.EnableBasedUponLevel), "GameStructure", "Level"),
            ...
            new ComponentHelp("EnableBasedUponPlayer", "Enable or a Disable a gameobject or UI button based upon various conditions relating to a specific Player or otherwise.", typeof(GameStructure.Players.Components.EnableBasedUponPlayer), "GameStructure", "Player"),
            ...
            new ComponentHelp("EnableBasedUponWorld", "Enable or a Disable a gameobject or UI button based upon various conditions relating to a specific World or otherwise.", typeof(GameStructure.Worlds.Components.EnableBasedUponWorld), "GameStructure", "World"),
