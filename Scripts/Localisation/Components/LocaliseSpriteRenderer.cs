...
{
    /// <summary>
    /// Localises an sprite renderer based upon the given Key
    /// </summary>
    [RequireComponent(typeof(UnityEngine.UI.Image))]
    [AddComponentMenu("Game Framework/Localisation/Localise SpriteRenderer")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/localisation/")]
    public class LocaliseSpriteRenderer : RunOnMessage<LocalisationChangedMessage>
    {
        /// <summary>
        /// Localization Setup.
        /// </summary>
        ...
        void OnLocalise()
        {
            _spriteRendererComponent.sprite = Sprite.GetSprite();
        }
