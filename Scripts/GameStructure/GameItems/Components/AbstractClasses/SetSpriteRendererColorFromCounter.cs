...
{
    /// <summary>
    /// Set Sprint color from a counter from the specified GameItem
    /// </summary>
    [RequireComponent(typeof(SpriteRenderer))]
    public abstract class SetSpriteRendererColorFromCounter<T> : SetFromCounterNormalisedAmount<SpriteRenderer, T> where T : GameItem
    {
        /// <summary>
