...
namespace GameFramework.GameStructure.GameItems.Components
{
    ...
    [AddComponentMenu("Game Framework/GameStructure/Common/Set Image Color From Counter")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/")]
    public class SetImageColorFromCounter : SetFromCounterNormalisedAmount<Image>
    {
        /// <summary>
