...
{
//    [CustomPropertyDrawer(typeof(Variables))]
    public class VariablesObjectDrawer : PropertyDrawer
    {
        readonly float _propertyRowHeight = EditorGUIUtility.singleLineHeight + 2;

        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            //var stringVariablesProperty = property.FindPropertyRelative("StringVariables");
            //var vector2VariablesProperty = property.FindPropertyRelative("Vector2Variables");
