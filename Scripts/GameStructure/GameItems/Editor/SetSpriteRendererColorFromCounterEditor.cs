...
{
    [CustomEditor(typeof(SetSpriteRendererColorFromCounter))]
    public class SetSpriteRendererColorFromCounterEditor : GameItemContextBaseRunnableCounterEditor
    {
        ...
        {
            HelpRect = EditorHelper.ShowHideableHelpBox("GameFramework.GameStructure.SetSpriteRendererColorFromCounterEditor", "Use this component to set the SpriteRenderer color from a gradient based upon the value of a built in or custom counter between it's minimum and maximum values for the specified GameItem.", HelpRect);
        }
