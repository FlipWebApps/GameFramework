...
{
    public abstract class SetColorFromCounterEditor : GameItemContextBaseRunnableCounterEditor
    {
        ...
        {
            HelpRect = EditorHelper.ShowHideableHelpBox("GameFramework.GameStructure.SetColorFromCounterEditor", "Use this component to set the target a color from a gradient based upon the value of a counter between it's minimum and maximum values for the specified GameItem.", HelpRect);
        }
