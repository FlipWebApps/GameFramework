...
namespace GameFramework.GameStructure.GameItems.Editor.AbstractClasses
{
    ...
    {
        SerializedProperty _reactToChangesProperty;
        ...
        {
            _reactToChangesProperty = serializedObject.FindProperty("_reactToChanges");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(_reactToChangesProperty);
