...
{
    [CustomEditor(typeof(SetImageColorFromCounter))]
    public class SetImageColorFromCounterEditor : GameItemContextBaseRunnableCounterEditor
    {
        ...
        {
            HelpRect = EditorHelper.ShowHideableHelpBox("GameFramework.GameStructure.SetImageColorFromCounterEditor", "Use this component to set the Image's color from a gradient based upon the value of a built in or custom counter between it's minimum and maximum values for the specified GameItem.", HelpRect);
        }
