...
{
    /// <summary>
    /// Set a transform rotation from a Level variable
    /// </summary>
    [AddComponentMenu("Game Framework/GameStructure/Levels/Set Rotation From Level Variable")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/levels/")]
    public class SetRotationFromLevelVariable : SetRotationFromGameItemVariable<Level>
    {
        /// <summary>
