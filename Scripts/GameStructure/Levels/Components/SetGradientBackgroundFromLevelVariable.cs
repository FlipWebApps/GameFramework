...
{
    /// <summary>
    /// Set gradient background colors from a Level variable
    /// </summary>
    [AddComponentMenu("Game Framework/GameStructure/Levels/Set Gradient Background From Level Variable")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/levels/")]
    public class SetGradientBackgroundFromLevelVariable : SetGradientBackgroundFromGameItemVariable<Level>
    {
        /// <summary>
