...
{
    /// <summary>
    /// Set a transform scale from a Level variable
    /// </summary>
    [AddComponentMenu("Game Framework/GameStructure/Levels/Set Scale From Level Variable")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/levels/")]
    public class SetScaleFromLevelVariable : SetScaleFromGameItemVariable<Level>
    {
        /// <summary>
