...
{
    /// <summary>
    /// Set a Image fill amount from the normalised value of the specified Level counter
    /// </summary>
    [AddComponentMenu("Game Framework/GameStructure/Levels/Set Image Fill Amount From Level Counter")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/levels/")]
    public class SetImageFillAmountFromLevelCounter : SetImageFillAmountFromCounter<Level>
    {
        /// <summary>
