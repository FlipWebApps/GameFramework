...
{
    /// <summary>
    /// Set a transform position from a Level variable
    /// </summary>
    [AddComponentMenu("Game Framework/GameStructure/Levels/Set Position From Level Variable")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/levels/")]
    public class SetPositionFromLevelVariable : SetPositionFromGameItemVariable<Level>
    {
        /// <summary>
