...
{
    /// <summary>
    /// Set a Image color from the normalised value of the specified Level counter
    /// </summary>
    [AddComponentMenu("Game Framework/GameStructure/Levels/Set Image Color From Level Counter")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/levels/")]
    public class SetImageColorFromLevelCounter : SetImageColorFromCounter<Level>
    {
        /// <summary>
