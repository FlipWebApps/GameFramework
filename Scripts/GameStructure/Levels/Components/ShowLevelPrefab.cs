...
{
    /// <summary>
    /// Create an instance of the specified prefab from a referenced Level
    /// </summary>
    [AddComponentMenu("Game Framework/GameStructure/Levels/Show Level Prefab")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/levels/")]
    public class ShowLevelPrefab : ShowPrefab<Level>
    {
        /// <summary>
