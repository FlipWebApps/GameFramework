...
{
    /// <summary>
    /// Enable or a Disable a gameobject based upon whether a specified Level is selected.
    /// </summary>
    /// <typeparam name="T">The type of the GameItem that we are creating a button for</typeparam>
    [AddComponentMenu("Game Framework/GameStructure/Levels/EnableBasedUponSelectedLevel")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/levels/")]
    public class EnableBasedUponLevelSelected : EnableBasedUponSelected<Level>
    {
        /// <summary>
