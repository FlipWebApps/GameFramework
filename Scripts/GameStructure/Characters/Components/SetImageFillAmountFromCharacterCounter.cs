...
{
    /// <summary>
    /// Set a Image fill amount from the normalised value of the specified Character counter
    /// </summary>
    [AddComponentMenu("Game Framework/GameStructure/Characters/Set Image Fill Amount From Character Counter")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/characters/")]
    public class SetImageFillAmountFromCharacterCounter : SetImageFillAmountFromCounter<Character>
    {
        /// <summary>
