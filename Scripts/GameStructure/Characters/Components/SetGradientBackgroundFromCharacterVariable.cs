...
{
    /// <summary>
    /// Set gradient background colors from a Character variable
    /// </summary>
    [AddComponentMenu("Game Framework/GameStructure/Characters/Set Gradient Background From Character Variable")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/characters/")]
    public class SetGradientBackgroundFromCharacterVariable : SetGradientBackgroundFromGameItemVariable<Character>
    {
        /// <summary>
