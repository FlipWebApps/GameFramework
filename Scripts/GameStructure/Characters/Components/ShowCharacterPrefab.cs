...
{
    /// <summary>
    /// Create an instance of the specified prefab from a referenced Character
    /// </summary>
    [AddComponentMenu("Game Framework/GameStructure/Characters/Show Character Prefab")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/characters/")]
    public class ShowCharacterPrefab : ShowPrefab<Character>
    {
        /// <summary>
