...
{
    /// <summary>
    /// Enable or a Disable a gameobject based upon whether a specified Character is unlocked.
    /// </summary>
    /// <typeparam name="T">The type of the GameItem that we are creating a button for</typeparam>
    [AddComponentMenu("Game Framework/GameStructure/Characters/EnableBasedUponUnlockedCharacter")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/characters/")]
    public class EnableBasedUponCharacterUnlocked : EnableBasedUponUnlocked<Character>
    {
        /// <summary>
