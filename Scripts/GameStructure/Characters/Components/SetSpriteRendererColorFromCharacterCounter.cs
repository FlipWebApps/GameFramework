...
{
    /// <summary>
    /// Set a SpriteRenderer color from the normalised value of the specified Character counter
    /// </summary>
    [AddComponentMenu("Game Framework/GameStructure/Characters/Set SpriteRenderer Color From Character Counter")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/characters/")]
    public class SetSpriteRendererColorFromCharacterCounter : SetSpriteRendererColorFromCounter<Character>
    {
        /// <summary>
