...
{
    /// <summary>
    /// Set a transform scale from a Character variable
    /// </summary>
    [AddComponentMenu("Game Framework/GameStructure/Characters/Set Scale From Character Variable")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/characters/")]
    public class SetScaleFromCharacterVariable : SetScaleFromGameItemVariable<Character>
    {
        /// <summary>
