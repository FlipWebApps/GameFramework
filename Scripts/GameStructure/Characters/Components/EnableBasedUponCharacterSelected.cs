...
{
    /// <summary>
    /// Enable or a Disable a gameobject based upon whether a specified Character is selected.
    /// </summary>
    /// <typeparam name="T">The type of the GameItem that we are creating a button for</typeparam>
    [AddComponentMenu("Game Framework/GameStructure/Characters/EnableBasedUponSelectedCharacter")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/characters/")]
    public class EnableBasedUponCharacterSelected : EnableBasedUponSelected<Character>
    {
        /// <summary>
