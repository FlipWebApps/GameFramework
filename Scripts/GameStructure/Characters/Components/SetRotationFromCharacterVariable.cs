...
{
    /// <summary>
    /// Set the transform rotation from a Character variable
    /// </summary>
    [AddComponentMenu("Game Framework/GameStructure/Characters/Set Rotation From Character Variable")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/characters/")]
    public class SetRotationFromCharacterVariable : SetRotationFromGameItemVariable<Character>
    {
        /// <summary>
