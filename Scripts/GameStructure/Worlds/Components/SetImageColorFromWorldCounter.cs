...
{
    /// <summary>
    /// Set a Image color from the normalised value of the specified World counter
    /// </summary>
    [AddComponentMenu("Game Framework/GameStructure/Worlds/Set Image Color From World Counter")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/worlds/")]
    public class SetImageColorFromWorldCounter : SetImageColorFromCounter<World>
    {
        /// <summary>
