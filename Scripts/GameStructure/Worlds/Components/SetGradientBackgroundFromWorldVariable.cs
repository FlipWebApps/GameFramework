...
{
    /// <summary>
    /// Set gradient background colors from a World variable
    /// </summary>
    [AddComponentMenu("Game Framework/GameStructure/Worlds/Set Gradient Background From World Variable")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/worlds/")]
    public class SetGradientBackgroundFromWorldVariable : SetGradientBackgroundFromGameItemVariable<World>
    {
        /// <summary>
