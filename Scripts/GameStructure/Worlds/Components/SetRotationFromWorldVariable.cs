...
{
    /// <summary>
    /// Set a transform rotation from a World variable
    /// </summary>
    [AddComponentMenu("Game Framework/GameStructure/Worlds/Set Rotation From World Variable")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/worlds/")]
    public class SetRotationFromWorldVariable : SetRotationFromGameItemVariable<World>
    {
        /// <summary>
