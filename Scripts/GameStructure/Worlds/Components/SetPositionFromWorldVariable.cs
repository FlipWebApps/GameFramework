...
{
    /// <summary>
    /// Set a transform position from a World variable
    /// </summary>
    [AddComponentMenu("Game Framework/GameStructure/Worlds/Set Position From World Variable")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/worlds/")]
    public class SetPositionFromWorldVariable : SetPositionFromGameItemVariable<World>
    {
        /// <summary>
