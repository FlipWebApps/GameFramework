...
{
    /// <summary>
    /// Set a Image fill amount from the normalised value of the specified World counter
    /// </summary>
    [AddComponentMenu("Game Framework/GameStructure/Worlds/Set Image Fill Amount From World Counter")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/worlds/")]
    public class SetImageFillAmountFromWorldCounter : SetImageFillAmountFromCounter<World>
    {
        /// <summary>
