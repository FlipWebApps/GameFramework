...
{
    /// <summary>
    /// Set a SpriteRenderer color from the normalised value of the specified World counter
    /// </summary>
    [AddComponentMenu("Game Framework/GameStructure/Worlds/Set SpriteRenderer Color From World Counter")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/worlds/")]
    public class SetSpriteRendererColorFromWorldCounter : SetSpriteRendererColorFromCounter<World>
    {
        /// <summary>
