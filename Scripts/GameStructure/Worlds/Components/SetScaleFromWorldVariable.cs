...
{
    /// <summary>
    /// Set a transform scale from a World variable
    /// </summary>
    [AddComponentMenu("Game Framework/GameStructure/Worlds/Set Scale From World Variable")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/worlds/")]
    public class SetScaleFromWorldVariable : SetScaleFromGameItemVariable<World>
    {
        /// <summary>
