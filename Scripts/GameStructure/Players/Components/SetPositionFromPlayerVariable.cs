...
{
    /// <summary>
    /// Set a transform position from a Player variable
    /// </summary>
    [AddComponentMenu("Game Framework/GameStructure/Players/Set Position From Player Variable")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/players/")]
    public class SetPositionFromPlayerVariable : SetPositionFromGameItemVariable<Player>
    {
        /// <summary>
