...
{
    /// <summary>
    /// Enable or a Disable a gameobject based upon whether a specified Player is selected.
    /// </summary>
    /// <typeparam name="T">The type of the GameItem that we are creating a button for</typeparam>
    [AddComponentMenu("Game Framework/GameStructure/Players/EnableBasedUponSelectedPlayer")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/players/")]
    public class EnableBasedUponPlayerSelected : EnableBasedUponSelected<Player>
    {
        /// <summary>
