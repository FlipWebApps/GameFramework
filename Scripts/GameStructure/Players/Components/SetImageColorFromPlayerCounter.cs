...
{
    /// <summary>
    /// Set a Image color from the normalised value of the specified Player counter
    /// </summary>
    [AddComponentMenu("Game Framework/GameStructure/Players/Set Image Color From Player Counter")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/players/")]
    public class SetImageColorFromPlayerCounter : SetImageColorFromCounter<Player>
    {
        /// <summary>
