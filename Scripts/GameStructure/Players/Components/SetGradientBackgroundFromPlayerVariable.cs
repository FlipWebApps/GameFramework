...
{
    /// <summary>
    /// Set gradient background colors from a Player variable
    /// </summary>
    [AddComponentMenu("Game Framework/GameStructure/Players/Set Gradient Background From Player Variable")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/players/")]
    public class SetGradientBackgroundFromPlayerVariable : SetGradientBackgroundFromGameItemVariable<Player>
    {
        /// <summary>
