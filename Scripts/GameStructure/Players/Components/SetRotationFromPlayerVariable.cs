...
{
    /// <summary>
    /// Set a transform rotation from a Player variable
    /// </summary>
    [AddComponentMenu("Game Framework/GameStructure/Players/Set Rotation From Player Variable")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/players/")]
    public class SetRotationFromPlayerVariable : SetRotationFromGameItemVariable<Player>
    {
        /// <summary>
