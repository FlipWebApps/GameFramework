...
{
    /// <summary>
    /// Set a Image fill amount from the normalised value of the specified Player counter
    /// </summary>
    [AddComponentMenu("Game Framework/GameStructure/Players/Set Image Fill Amount From Player Counter")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/players/")]
    public class SetImageFillAmountFromPlayerCounter : SetImageFillAmountFromCounter<Player>
    {
        /// <summary>
