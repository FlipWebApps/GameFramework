...
{
    /// <summary>
    /// Set a SpriteRenderer color from the normalised value of the specified Player counter
    /// </summary>
    [AddComponentMenu("Game Framework/GameStructure/Players/Set SpriteRenderer Color From Player Counter")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/players/")]
    public class SetSpriteRendererColorFromPlayerCounter : SetSpriteRendererColorFromCounter<Player>
    {
        /// <summary>
