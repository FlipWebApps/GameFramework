...
{
    /// <summary>
    /// Set a transform scale from a Player variable
    /// </summary>
    [AddComponentMenu("Game Framework/GameStructure/Players/Set Scale From Player Variable")]
    [HelpURL("http://www.flipwebapps.com/unity-assets/game-framework/game-structure/players/")]
    public class SetScaleFromPlayerVariable : SetScaleFromGameItemVariable<Player>
    {
        /// <summary>
