...
{
    [CustomEditor(typeof(GameActionPhysics2DRigidbodyType))]
    public class GameActionPhysics2DRigidbodyTypeEditor : GameActionEditor
    {
        /// <summary>
        /// Draw the Editor GUI
        /// </summary>
        protected override void DrawGUI()
        {
            ...
            EditorHelper.DrawProperties(serializedObject, new List<string>() { "_bodyType" });
#else
            EditorGUILayout.HelpBox("Requires Unity 5.6 or newer", MessageType.Warning);
#endif
        }
    }
}
