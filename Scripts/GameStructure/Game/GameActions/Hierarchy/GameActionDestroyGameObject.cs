...
namespace GameFramework.GameStructure.Game.GameActions.Hierarchy
{
    ...
    /// </summary>
    [System.Serializable]
    [ClassDetails("Destroy GameObject", "Hierarchy/Destroy GameObject", "Destroy the specified GameObject.")]
    public class GameActionDestroyGameObject : GameActionTarget
    {
        /// <summary>
        /// Perform the action
        /// </summary>
